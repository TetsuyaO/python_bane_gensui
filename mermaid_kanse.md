...
flowchart TB
    ...
    style NeuralNetwork fill:#f9f,stroke:#333,stroke-width:2px
    style DataLoss fill:#dfd,stroke:#333,stroke-width:2px
    style PhysicsLoss fill:#ddf,stroke:#333,stroke-width:2px
    style TotalLoss fill:#ffd,stroke:#333,stroke-width:2px
```